      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 bg-white shadow-xl border border-[#E2E8F0] rounded-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-[#0F172A] font-['Poppins'] mb-2">Admin Login</h2>
            <p className="text-[#475569] font-['Inter']">
              Access institutional administration panel
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Button
              onClick={handleLogin}
              className="w-full bg-[#22C55E] hover:bg-[#16a34a] text-white rounded-lg py-3 font-['Inter'] font-medium"
            >
              Access Admin Panel
            </Button>
          </div>
