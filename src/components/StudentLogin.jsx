...
export default function StudentLogin({ navigate, authenticateUser }) {
  ...
  const handleLogin = async () => {
    ...
    if (user) {
      navigate('student-dashboard', 'student', user);
    } else {
      setError("Account not found. Please check your credentials or sign up if you don't have an account.");
    }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 bg-white shadow-xl border border-[#E2E8F0] rounded-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-[#0F172A] font-['Poppins'] mb-2">Student Login</h2>
